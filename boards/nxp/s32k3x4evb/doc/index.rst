...
- NXP S32K344
   ...
   - Arm Cortex-M7 (2 cores in Lock-Step)
   - Core frequency up to 160 MHz
   - 512 kB SRAM with ECC
   - 128 kB D flash with ECC
   - 4 MB P flash with ECC
   - HSE-B Security Module
   - ASIL-D Functional safety block
   - Ethernet, CAN FD/XL, QSPI, SPI, I2C, UART, LIN, ADC
...
sw1 / user_button_1      USERSW1  PTB19            GPIO82 / EIRQ1
=======================  =======  ==============   =========================
...
To build ``flash_shell`` sample application together and generate HEX files suitable for flashing, run:

.. code-block:: console

   west build -p -b s32k3x4_t172/s32k344 samples/drivers/flash_shell --sysbuild
   west flash

The resulting artifacts are:

* MCUboot: ``build/zephyr/zephyr.hex``
